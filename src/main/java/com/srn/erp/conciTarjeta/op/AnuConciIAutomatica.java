...
public class AnuConciIAutomatica extends Operation {

	public AnuConciIAutomatica() {
	}
	...
	public void execute(MapDatos mapaDatos) throws BaseException {
		...
		archLoteConciDet.anulacionConciliacionAutomatica(cuponesPOSNETS,cuponesTARJETAS);
	  ...
	  private IDataSet getDataSetAnulacionPOSNET() {
		    ...
		    dataset.create("TCuponAnuPOSNETConciAut");
	  ...
	  private IDataSet getDataSetAnulacionTARJETA() {
		    IDataSet dataset = new TDataSet();
		    dataset.create("TCuponAnuTARJETAConciAut");
