...
public class TraerModAsiLiq extends Operation {

	public TraerModAsiLiq() {
	}
	...
	private void cargarRegistroCabModeloLiq(IDataSet dataset, Integer oid_modelo_liq, String codigo, String descripcion, Boolean activo) {
		dataset.append();
