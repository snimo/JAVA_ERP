...
public class TraerSocioPorTarjeta extends Operation { 

  public TraerSocioPorTarjeta() { 
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException { 
    ...
    Sujeto sujeto = Sujeto.getSujetoByNroTarjeta(mapaDatos.getString("nro"), this.getSesion());
