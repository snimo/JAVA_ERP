...
public class DBTasaIVA extends DBObjetoPersistente {

  public static final String OID_TASA_IVA = "oid_tasa_iva";
  ...
  protected void insert(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    final int OID_TASA_IVA = 1;
    final int OID_CONC_IMPU = 2;
    final int FEC_VIGENCIA = 3;
    final int PORC = 4;
    final int ACTIVO = 5;

    TasaIVA pers = (TasaIVA) objetoPersistente;

    StringBuffer sqlInsert = new StringBuffer();
    sqlInsert.append(" insert into imTasaIVA "+
                     " ( "+
                      "OID_TASA_IVA,"+
                      "OID_CONC_IMPU,"+
                      "FEC_VIGENCIA,"+
    ...
    qInsert.setInt(OID_TASA_IVA,pers.getOID());
  ...
  protected void update(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    final int PORC = 3;
    final int ACTIVO = 4;
    final int OID_TASA_IVA = 5;

    TasaIVA pers = (TasaIVA) objetoPersistente;

    StringBuffer sqlUpdate= new StringBuffer();
    sqlUpdate.append(" update imTasaIVA set "+
              "oid_conc_impu=?"+
              ",fec_vigencia=?"+
              ",porc=?"+
              ",activo=?"+
    ...
    qUpdate.setInt(OID_TASA_IVA,pers.getOID());
  ...
  protected void delete(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    TasaIVA pers = (TasaIVA) objetoPersistente;
    StringBuffer sqlUpdate = new StringBuffer();
    sqlUpdate.append("update imTasaIVA "+
                     " set activo=0 " +
                     " where " +
                     " oid_tasa_iva=? ");
    PreparedStatement qUpdate = getSesion().getConexionBD().prepareStatement(sqlUpdate.toString());
  ...
  private PreparedStatement selectByOID(Object aCondiciones) throws BaseException, SQLException {
    ...
    textSQL.append("SELECT * FROM  imTasaIVA ");
    textSQL.append(" WHERE oid_tasa_iva = ? ");
    PreparedStatement querySelect = getSesion().getConexionBD().prepareStatement(textSQL.toString());
    int oid = ( (Integer) aCondiciones).intValue();
    querySelect.setInt(OID_TASA_IVA, oid);
    return querySelect;
  }
  ...
  private PreparedStatement selectAllHelp(Object aCondiciones) throws BaseException, SQLException {
    ...
    textSQL.append("SELECT oid_tasa_iva oid,oid_conc_impu codigo,  descripcion ,activo ");
    textSQL.append(" from imTasaIVA");
  ...
  public static List getTasasIVAByConceptoImpu(ConceptoImpuesto conceptoImpuesto,
    ...
    return (List) ObjetoLogico.getObjects(TasaIVA.NICKNAME,
