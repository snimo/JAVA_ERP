...
public class UploadFotoPrincipalExcluido3 extends Operation {

	public UploadFotoPrincipalExcluido3() {
	}

	public void execute(MapDatos mapaDatos) throws BaseException {

		String nombreArchivo = "FPE_3_"+mapaDatos.getString("nuevo_nombre");
