inherited FSelLegParaPlanifRotas: TFSelLegParaPlanifRotas
  Left = 69
  Top = 118
  Width = 894
  Height = 613
  Caption = 'Seleccionar Legajos para planificaci'#243'n de Rotas'
  PixelsPerInch = 96
  TextHeight = 13
  object Panel1: TPanel [0]
    ...
    object Label1: TLabel
      ...
      Width = 243
      Height = 16
      Caption = 'Ingresar los legajos a planificar sus rotas'
    ...
    object Label2: TLabel
      ...
      Width = 142
      Height = 16
      Caption = 'Planificaci'#243'n a partir del'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clNavy
      Font.Height = -13
      Font.Name = 'MS Sans Serif'
    ...
    object snDBLookup1: TsnDBLookup
      ...
      Properties.ListSource = DSClasifLegAct
      TabOrder = 2
      Width = 281
    end
    ...
    OnFormFunction = <
      item
        Source.Strings = (
          ...
          'begin'
          ' THelpClasifLegAct.loadFromHelp('#39'HelpClasifLegActivos'#39'); '
          ' TInput.Close;'
          ' TInput.Open;'
          ' TraerClasifLegajo();'
          '  dumyActu();'
          ...
          ''
            ...
            'sificador'#39');'
          ''
          '   HelpValoresClasificador.NickName   :=  '#39'su.Legajo'#39';'
          ...
          ''
          ''
          '  FormPlanifRotas.params :=  variable.getValue('#39'parametros'#39');'
          '  FormPlanifRotas.Ventana := getVentana();'
          '  FormPlanifRotas.Mostrar(false);'
          ''
          'end;'
          '')
      end>
  ...
  object THelpClasifLegAct: TsnTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <>
    ...
    Left = 391
    Top = 78
    object THelpClasifLegActoid: TIntegerField
      FieldName = 'oid'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object THelpClasifLegActcodigo: TStringField
      FieldName = 'codigo'
      Size = 50
    end
    object THelpClasifLegActdescripcion: TStringField
      FieldName = 'descripcion'
      Size = 100
    end
  end
  object DSClasifLegAct: TDataSource
    DataSet = THelpClasifLegAct
    Left = 426
    Top = 76
  end
  ...
  object FormPlanifRotas: TFormulario
    Nombre = 'TFPlanifRotas'
