...
public class DBTipoDocumento extends DBObjetoPersistente {
  ...
  protected void insert(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    sqlInsert.append(" insert into veTipoDocumento "+
                     " ( "+
                      ...
                      "CODIGO,"+
                      "DESCRIPCION,"+
                      "ACTIVO,COMPORTAMIENTO,CODIGO_FE)"+
                      " values "+
                      "("+
                      "?,"+
                      "?,"+
    ...
    if (pers.getCodigoFE()!=null)
    	qInsert.setInt(CODIGO_FE,pers.getCodigoFE());
    else
    	qInsert.setNull(CODIGO_FE,java.sql.Types.INTEGER);
  ...
  protected void update(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    final int CODIGO_FE = 5;
    final int OID_TIPO_DOCUMENTO = 6;
    ...
    if (pers.getCodigoFE()!=null)
    	qUpdate.setInt(CODIGO_FE,pers.getCodigoFE());
    else
    	qUpdate.setNull(CODIGO_FE,java.sql.Types.INTEGER);
