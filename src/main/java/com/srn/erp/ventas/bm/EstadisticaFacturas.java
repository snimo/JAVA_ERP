...
public class EstadisticaFacturas extends ObjetoLogico { 
  ...
  public static String NICKNAME = "ve.EstadisticaFacturas";
 ...
 public static EstadisticaFacturas findByOid(Integer oid , ISesion aSesion) throws BaseException { 
   return (EstadisticaFacturas) getObjectByOid(NICKNAME,oid,aSesion);
  } 

 public static EstadisticaFacturas findByCodigo(String codigo , ISesion aSesion) throws BaseException { 
   return (EstadisticaFacturas) getObjectByCodigo(NICKNAME,codigo,aSesion);
  } 

 public void beforeSave() throws BaseException { 
 }
 
 public static List getEstadisticaFacturas(
		 java.util.Date fechaDesde,
		 java.util.Date fechaHasta,
		 List listaClasif,
		 ISesion aSesion) throws BaseException {
	 return DBEstadisticaFacturas.getEstadisticaFacturas(fechaDesde,fechaHasta,listaClasif,aSesion);
 }
