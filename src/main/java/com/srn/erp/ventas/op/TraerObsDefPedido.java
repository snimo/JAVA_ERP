...
public class TraerObsDefPedido extends Operation {

	public TraerObsDefPedido() {
	}
	...
	public void execute(MapDatos mapaDatos) throws BaseException {
		...
		Iterator iterObsCodifVtas = 
			ObsCodifVtas.getObsDefaultPedido(this.getSesion()).iterator();
	...
	private IDataSet getDataSet() {
		...
		dataset.create("TObsDefaultPedido");
