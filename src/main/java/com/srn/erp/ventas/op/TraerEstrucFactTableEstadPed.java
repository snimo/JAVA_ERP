...
public class TraerEstrucFactTableEstadPed extends Operation {

  HashTableDatos fechas = new HashTableDatos();
	
  public TraerEstrucFactTableEstadPed() {
  }
  ...
  private void enviarDatosFactTable(MapDatos mapaDatos) throws BaseException {
  	...
  	Iterator  iterEstadPedido = EstadisticaPedidos.getEstadisticaPedidos(
  			mapaDatos.getDate("fec_desde"),
  			mapaDatos.getDate("fec_hasta"),
  			getListaClasif(dsDimensiones),
  			this.getSesion()).iterator();
  	while (iterEstadPedido.hasNext()) {
  		EstadisticaPedidos estadisticaPedido = (EstadisticaPedidos) iterEstadPedido.next();
  		cargarEstadPed(dsFactTable,dsDimensiones,estadisticaPedido,moneda,tipoCambio);
  	}
  ...
  private void cargarEstadPed(IDataSet dsFactTable,
  		                        IDataSet dsDimensiones,
  		                        EstadisticaPedidos estad,
  		                        Moneda moneda,
