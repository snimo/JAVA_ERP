...
public class TraerCompoTipoUniEdi extends Operation {

  public TraerCompoTipoUniEdi() {
  }

  public void execute(MapDatos mapaDatos) throws BaseException {

    IDataSet ds = getDataSetComportamientos();
    Hashtable comportamientos = TipoUnidadEdilicia.getComportamientos();
  ...
  private IDataSet getDataSetComportamientos() {
    ...
    dataset.create("TCompoTipoUniEdi");
