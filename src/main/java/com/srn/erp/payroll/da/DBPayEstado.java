...
public class DBPayEstado extends DBObjetoPersistente {

  public static final String ESTADO = "estado";
  
  private static final int SELECT_ALL_ESTADOS = 100;
  ...
  public PreparedStatement prepararSelect(int aSelect, Object aCondiciones) throws BaseException, SQLException {
    ...
    switch (aSelect) { 
      ...
      case DBPayEstado.SELECT_ALL_ESTADOS: { 
  ...
  private PreparedStatement selectByCodigo(Object aCondiciones) throws BaseException, SQLException { 
    ...
    textSQL.append("SELECT * FROM  pay_estado "); 
  ...
  private PreparedStatement selectAllHelp(Object aCondiciones) throws BaseException, SQLException {
    ...
    textSQL.append(" from pay_estado");
...
return (List) ObjetoLogico.getObjects(PayEstado.NICKNAME,
		   DBPayEstado.SELECT_ALL_ESTADOS,
           null,
           new ListObserver(),
           aSesion);
}
