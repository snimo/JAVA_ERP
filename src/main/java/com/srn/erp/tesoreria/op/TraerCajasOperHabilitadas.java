...
public class TraerCajasOperHabilitadas extends Operation {

  public TraerCajasOperHabilitadas() {
  }

  public void execute(MapDatos mapaDatos) throws BaseException {
	IDataSet datasetCaja = getDataSetCaja();  
    Iterator iterCajasHabilitadas = Caja.getCajasOperativasHab(getSesion()).iterator();
    while (iterCajasHabilitadas.hasNext()) {
    	Caja caja = (Caja) iterCajasHabilitadas.next();
