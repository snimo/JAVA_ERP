...
public class TraerValoresEnCajaChequeCliente extends Operation {

  public TraerValoresEnCajaChequeCliente() {
  }
  ...
  private void traerValoresEnCajaChequeCliente(Caja caja) throws BaseException {
	  ...
	  Iterator iterValores = Valor.getChequesClientesEnCartera(caja,getSesion()).iterator();
