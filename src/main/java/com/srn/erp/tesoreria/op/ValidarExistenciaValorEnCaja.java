...
public class ValidarExistenciaValorEnCaja extends Operation {

  public ValidarExistenciaValorEnCaja() {
  }

  public void execute(MapDatos mapaDatos) throws BaseException {
  	
    Caja caja = Caja.findByOid(mapaDatos.getInteger("oid_caja"), getSesion());
    String compoTipoValor = mapaDatos.getString("compo_tipo_valor");
