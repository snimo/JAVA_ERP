...
public class TraerComportamientosCaja extends Operation {

  public TraerComportamientosCaja() {
  }

  public void execute(MapDatos mapaDatos) throws BaseException {

    Hashtable tipos = Caja.getTipos();
  ...
  private IDataSet getDataSetCaja() {
    ...
    dataset.create("TComportamientosCaja");
