...
public class CertificadoRetencionIVA extends ValorBase {

	public static String		ENTRADA	= "ENTRADA";

	public static String		SALIDA	= "SALIDA";
	
  public CertificadoRetencionIVA() {
  }
  ...
  public void save() throws BaseException {
    ...
    if (this.getTipoOper().equals(ENTRADA)) {
    	beforeSave();
    	this.setValorCertificado((Valor) Valor.getNew(Valor.NICKNAME,getSesion()));
