...
public class SimpleFTPClient
{
  ...
  /** Setter method for the remote file, this must include the sub-directory path relative
   to the users home directory, e.g youe going to download a file that is within a sub directory
   called sdir, and the file is named 
  */
  ...
  */
  ...
  public synchronized boolean connect()
  {
    ...
    URL url = new URL("ftp://"+user+":"+password+"@"+host+"/"+remoteFile+";type=txt");
