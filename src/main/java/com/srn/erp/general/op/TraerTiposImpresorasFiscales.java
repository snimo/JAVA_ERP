...
public class TraerTiposImpresorasFiscales extends Operation {

  public TraerTiposImpresorasFiscales() {
  }

  public void execute(MapDatos mapaDatos) throws BaseException {
    int oid = 0;
    IDataSet dataset = getDataSetTipo();
    List lista = ImpresoraFiscal.getTipos();
  ...
  private IDataSet getDataSetTipo() {
    ...
    dataset.create("TTiposImpFiscales");
