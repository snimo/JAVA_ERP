...
public class TraerDimenEstadComproProv extends Operation {

	HashTableDatos preciosCompraClasif = new HashTableDatos();

	public TraerDimenEstadComproProv() {
	}
	  ...
	  public void execute(MapDatos mapaDatos) throws BaseException {
		  ...
		  private void cargarDimensionesComprobantes(IDataSet ds) {
		  	...
		  	cargarRegistroDimenEstadOC(ds,"02-Comprobantes","Tipo Cta. Cte.",new Integer(0),new Boolean(false),new Integer(0),TipoCtaCteProv.NICKNAME,new Integer(5),"ROW");
		  	cargarRegistroDimenEstadOC(ds,"02-Comprobantes","Concepto Factura",new Integer(0),new Boolean(false),new Integer(0),ConcFactProv.NICKNAME,new Integer(6),"ROW");
		  	cargarRegistroDimenEstadOC(ds,"02-Comprobantes","Cuenta Contable",new Integer(0),new Boolean(false),new Integer(0),Cuenta.NICKNAME,new Integer(6),"ROW");
		  ...
		  private void cargarDimensionesContables(IDataSet ds) throws BaseException {
			  int secu = 0;
