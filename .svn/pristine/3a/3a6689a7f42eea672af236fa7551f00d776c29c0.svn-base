...
public class CentroImputacion extends ObjetoLogico implements IEntidadClasificable {

	public CentroImputacion() {
	}

	public static String NICKNAME = "co.CentroImputacion";
	...
	public static CentroImputacion findByOid(Integer oid, ISesion aSesion)
			throws BaseException {
		return (CentroImputacion) getObjectByOid(NICKNAME, oid, aSesion);
	}

	public static CentroImputacion findByCodigo(String codigo, ISesion aSesion)
			throws BaseException {
		return (CentroImputacion) getObjectByCodigo(NICKNAME, codigo, aSesion);
	}
