...
public class SaveHabIngEgrLeg extends Operation {

	public SaveHabIngEgrLeg() {
	}
	...
	public void execute(MapDatos mapaDatos) throws BaseException {
		...
		if (!(habilitar.equals(NovedadPermisoCIP.AMBOS))) {
			...
			if (habilitar.equals(NovedadPermisoCIP.HAB_ING)) {
			...
			novedadPermisoCIP.setPermisoIngreso(NovedadPermisoCIP.HAB_ING);
			novedadPermisoCIP.setPermisoEgreso(NovedadPermisoCIP.HAB_EGR);
		}
