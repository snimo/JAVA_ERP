...
public class AnuConciIndMovPOSNET extends Operation {

	public AnuConciIndMovPOSNET() {
	}
	...
	public void execute(MapDatos mapaDatos) throws BaseException {
		...
		archLoteConciDet.anularPreconciliacion(cuponesPOSNETS,cuponesTARJETAS);
	  ...
	  private IDataSet getDataSetAnulacionPOSNET() {
		    ...
		    dataset.create("TCuponAnuPOSNETPreconci");
	  ...
	  private IDataSet getDataSetAnulacionTARJETA() {
		    IDataSet dataset = new TDataSet();
		    dataset.create("TCuponAnuTARJETAPreconci");
