...
public class DBEstadosExcluidosUltNroActa extends DBObjetoPersistente {

	public static final String OID_ESTADO = "oid_estado";
	public static final String DESCRIPCION = "descripcion";
	public static final String ULT_NRO = "ult_nro";

	public DBEstadosExcluidosUltNroActa() {
	}
	...
	private PreparedStatement selectAll(Object aCondiciones) throws BaseException, SQLException {
		...
		textSQL.append(" a.oid_estado,b.descripcion,max(nro_acta) ult_nro FROM excNovedades a , excEstados b , excindividuo c  ");
		textSQL.append(" where a.oid_estado=b.oid_estado and a.activo=1 AND c.oid_individuo = a.oid_individuo AND c.activo=1 group by a.oid_estado,b.descripcion ");
		PreparedStatement querySelect = getSesion().getConexionBD().prepareStatement(textSQL.toString());
		return querySelect;
	}
	...
	public static List getAllUltNrosEstados(ISesion aSesion) throws BaseException {
		return (List) ObjetoLogico.getObjects(EstadosExcluidosUltNroActa.NICKNAME, DBEstadosExcluidosUltNroActa.SELECT_ALL, null,
