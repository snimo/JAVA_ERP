...
import framework.request.bl.XML.TDataSet;
 ...
 public class TraerUbicacionDeposito extends Operation {

  public TraerUbicacionDeposito() {
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
    ...
    while (iterUbiDepo.hasNext()) {
      ...
      cargarRegistroUbicacionDeposito(dsUbiDepo,
                                      ...
                                      ubiDepo.getSecu(),
                                      ubiDepo.isActivo(),
                                      ubiDepo.isUbicacionPorDefecto());
      Iterator iterProdHab = ubiDepo.getProductosHabilitados().iterator();
      while (iterProdHab.hasNext()) {
        ProdHabUbiDepo prodHabUbiDepo = (ProdHabUbiDepo) iterProdHab.next();
        cargarProductosHab(dsProdHab,ubiDepo,prodHabUbiDepo);
      }
    }
  ...
  private IDataSet getDataSetUbicacionDeposito() {
    ...
    dataset.fieldDef(new Field("ubi_default",Field.BOOLEAN, 0));
    return dataset;
  }
  ...
  private void cargarDeposito(IDataSet dataset,
    ...
    dataset.fieldValue("activo", deposito.isActivo());
  }
  ...
  private void cargarRegistroUbicacionDeposito(IDataSet dataset,
                         ...
                         Integer secu,
                         Boolean activo,
                         boolean ubiDefault) throws BaseException {
    dataset.append();
    ...
    dataset.fieldValue("ubi_default",ubiDefault);
  }
}
