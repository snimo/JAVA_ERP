...
public class FactoryComproAnticipoProveedor extends FactoryComproProveedorBase {

  public FactoryComproAnticipoProveedor() {
  }

  public void cargarObjeto(IObjetoLogico objLog, IDBObjetoPersistente db) throws BaseException {
  	
  	
    ComproAnticipoProveedor comproproveedor = (ComproAnticipoProveedor ) objLog;
