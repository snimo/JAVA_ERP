inherited FCargaEvalPot: TFCargaEvalPot
  Left = 208
  Top = 165
  Width = 856
  Height = 958
  Caption = 'Evaluaciones de Potencial'
        ...
        object Panel3: TPanel
          ...
          object Panel4: TPanel
            ...
            object snLabel1: TsnLabel
              ...
              Width = 283
              Height = 16
              Caption = 'EVALUACION Y GESTION DE POTENCIAL'
              Color = 12910561
            ...
            object Panel6: TPanel
              ...
              object Panel10: TPanel
                ...
                object snLabel5: TsnLabel
                  ...
                  Width = 185
                  Height = 16
                  Caption = 'EVALUACION DE POTENCIAL'
                  Color = clWindow
                  Font.Charset = ANSI_CHARSET
                  Font.Color = clWindowText
                  Font.Height = -13
              ...
              object Panel18: TPanel
                ...
                object srnDBButtonEdit2: TsrnDBButtonEdit
                  Left = 13
                  Top = 46
                  DataBinding.DataField = 'cod_val_pue_fut'
                  DataBinding.DataSource = dsEVALUCIONCAB
                  ParentFont = False
                  Properties.Buttons = <
                    item
                ...
                object snDBEdit11: TsnDBEdit
                  ...
                  Top = 46
                  TabStop = False
                  DataBinding.DataField = 'desc_val_pue_fut'
                  DataBinding.DataSource = dsEVALUCIONCAB
                  ParentFont = False
                  Properties.Alignment.Horz = taLeftJustify
                  Properties.ReadOnly = True
  ...
  inherited DriverEvent: TDriverEvent
    ...
    OnValidate = <
      ...
      item
        ...
        Source.Strings = (
          'begin'
          '    ValidarValorClasifEntidadPuestoFut(Sender.AsString);'
          'end.')
      end>
    OnChangeField = <
      item
    ...
    OnFormFunction = <
      item
        Source.Strings = (
          ...
          '  operacion.AddAtribute('#39'POTEN'#39','#39#39');'
          '  operacion.execute();'
          'end;'
          ''
          ...
          'end;'
          ''
          'procedure MostrarHelpValoresClasifPuestoFut();'
          'begin   '
          
            '   HelpValoresClasifPuestoFut.NickName           :=  '#39'su.Legajo'#39 +
            ';'
          
            '   HelpValoresClasifPuestoFut.NroClasificador    :=  TLeyendasRe' +
            'porte.FieldName('#39'nro_clasif_puesto'#39').AsInteger;'
          '   HelpValoresClasifPuestoFut.Mostrar();'
          'end;'
          ''
          ''
          ''
          ...
          ''
          ''
          'procedure ValidarValorClasifEntidadPuestoFut(codigo : string);'
          'begin'
          ''
          '  if (codigo = '#39#39')'
          '     then begin'
          '             TEvaluacionCAB.EditRecord;'
            ...
            '             TEvaluacionCAB.FieldName('#39'oid_val_pue_fut'#39').AsInteg' +
            'er := 0;'
          
            '             TEvaluacionCAB.FieldName('#39'desc_val_pue_fut'#39').AsStri' +
            'ng := '#39#39';'
          '             exit;'
          '             end;'
          ''
          ...
          ''
          '  TEvaluacionCAB.EditRecord;'
          '  TEvaluacionCAB.FieldName('#39'oid_val_pue_fut'#39').AsInteger :='
          
            '       TValorClaifEntidad.FieldName('#39'oid_valor_clasif_ent'#39').AsIn' +
            'teger;'
          '  TEvaluacionCAB.FieldName('#39'desc_val_pue_fut'#39').AsString :='
          '      TValorClaifEntidad.FieldName('#39'descripcion'#39').AsString;'
          ''
          'end;'
          ''
    ...
    OnClickButtonEdit = <
      ...
      item
        ButtonEdit = 'srnDBButtonEdit2'
        Source.Strings = (
          'begin'
          '  MostrarHelpValoresClasifPuestoFut();'
          'end.')
      end>
  end
  ...
  object ImpresorEvaluacion: TFormulario
    Nombre = 'TFImpresorEvalPot'
    TipoForm = tipoImpresorCompro
    CreateAlwaysANewForm = False
    Left = 288
    Top = 280
  end
  object HelpValoresClasifPuestoFut: THelpValoresClasificador
    AsignarCampoCodigo = TEvaluacionCABcod_val_pue_fut
    NroClasificador = 0
    Left = 144
    Top = 584
  end
