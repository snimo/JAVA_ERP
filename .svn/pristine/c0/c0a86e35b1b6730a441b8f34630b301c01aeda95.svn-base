...
public class PorcLibRetIB extends ObjetoLogico {

  public PorcLibRetIB() {
  }

  public static String NICKNAME = "pag.PorcLibRetIB";
 ...
 public static PorcLibRetIB findByOid(Integer oid , ISesion aSesion) throws BaseException {
   return (PorcLibRetIB) getObjectByOid(NICKNAME,oid,aSesion);
  }

 public static PorcLibRetIB findByCodigo(String codigo , ISesion aSesion) throws BaseException {
   return (PorcLibRetIB) getObjectByCodigo(NICKNAME,codigo,aSesion);
  }
 ...
 public void beforeSave() throws BaseException {
  ...
  public static List getPorcentajesLibRetIB(SujetoImpositivo sujetoImpositivo,
    ...
    return DBPorcLibRetIB.getPorcentajesLibRetIB(sujetoImpositivo,aSesion);
  }
