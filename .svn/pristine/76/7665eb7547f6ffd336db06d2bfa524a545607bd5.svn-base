...
public class TraerPedidosPendientes extends Operation {

  public TraerPedidosPendientes() {
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
    ...
    List listaPedidos = PedidoCab.getPedidosPendDesp(
    		nroPedDesde,
    		nroPedHasta,
    		sujeto,
    		vendedor,
  ...
  private IDataSet getDataSetPedPendEnt() {
    ...
    dataset.create("TPedidosPendEnt");
  ...
  private IDataSet getDataSetDetPedPendEnt() {
    IDataSet dataset = new TDataSet();
    dataset.create("TDetPedidosPendEnt");
    dataset.fieldDef(new Field("oid_cco_ped", Field.INTEGER, 0));
  ...
  private void cargarDetalle(IDataSet dataset,
    ...
    dataset.fieldValue("desc_adic",comentario);
