...
public class TraerHelpFacturasParaNCConDet extends Operation {

  public TraerHelpFacturasParaNCConDet() {
  }
  ...
  private void traerFacturas(
    ...
    List listaFacturas =
        FacturaCab.getFacturasyND(nroExtDesde,nroExtHasta,fecDesde,fecHasta,sujeto,getSesion());
