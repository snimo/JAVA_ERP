...
public class UploadFotoPrincipalExcluido2 extends Operation {

	public UploadFotoPrincipalExcluido2() {
	}

	public void execute(MapDatos mapaDatos) throws BaseException {

		String nombreArchivo = "FPE_2_"+mapaDatos.getString("nuevo_nombre");
