...
public class DBAplicacionComproProvDet extends DBObjetoPersistente {
  ...
  public DBAplicacionComproProvDet() {
  }
  ...
  protected void insert(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    sqlInsert.append(" insert into cpComproProvAplDet "+
                     " ( "+
                      "OID_COMPRO_APL_DET,"+
                      "OID_CCO,"+
                      "OID_TRAN_VTO,"+
    ...
    if (pers.getTranprovvtoAplic()!=null)
      qInsert.setInt(OID_TRAN_VTO_APLIC,pers.getTranprovvtoAplic().getOID());
    else
  ...
  protected void update(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    sqlUpdate.append(" update cpComproProvAplDet set "+
              "oid_cco=?"+
              ",oid_tran_vto=?"+
              ",aplic_mon_ori=?"+
              ",cotiz_mon_ori_c=?"+
    ...
    if (pers.getTranprovvtoAplic()!=null)
      qUpdate.setInt(OID_TRAN_VTO_APLIC,pers.getTranprovvtoAplic().getOID());
    else
  ...
  protected void delete(IObjetoPersistente objetoPersistente) throws BaseException, SQLException {
    ...
    AplicacionComproProvDet pers = (AplicacionComproProvDet) objetoPersistente;
    StringBuffer sqlUpdate = new StringBuffer();
    sqlUpdate.append("update cpComproProvAplDet "+
                     " set activo=0 " +
                     " where " +
                     " oid_compro_apl_det=? ");
    PreparedStatement qUpdate = getSesion().getConexionBD().prepareStatement(sqlUpdate.toString());
  ...
  private PreparedStatement selectByOID(Object aCondiciones) throws BaseException, SQLException {
    ...
    textSQL.append("SELECT * FROM  cpComproProvAplDet ");
  ...
  private PreparedStatement selectAllHelp(Object aCondiciones) throws BaseException, SQLException {
    ...
    textSQL.append(" from cpComproProvAplDet");
