...
public class SaveRecluCompletoFormu extends Operation { 

  public SaveRecluCompletoFormu() { 
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
	...
	if (!procesoCandidato.isSeAnuncio()) 
		throw new ExceptionValidation(null,"Antes de indicar que completo el formulario, debe indicar que se anunció.");	
	
	if (procesoCandidato.getTipoFormulario() == null)
		throw new ExceptionValidation(null,"Debe ingresar el Tipo de Formulario");
	
	procesoCandidato.setCompletoTipoFormulario(true);
	procesoCandidato.setFecCompletoTipoFormulario(Util.getFechaActual(this.getSesion()));
