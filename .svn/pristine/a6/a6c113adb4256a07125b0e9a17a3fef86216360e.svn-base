...
public class DBEstadisticaOC extends DBObjetoPersistente {
  ...
  public static final String OID_CCO_DET = "oid_oc_det";
  ...
  private PreparedStatement selectByFechaDesdeHasta(Object aCondiciones) throws BaseException, SQLException {
    ...
    textSQL.append("   b.oid_proveedor, ");
    textSQL.append("   b.oid_cond_pago_1 oid_cond_pago, ");
    textSQL.append("   b.oid_sector_compra, ");
    textSQL.append("   a.oid_oc_det oid_oc_det, ");
    textSQL.append("   a.oid_cco_cpra oid_cco, ");
    textSQL.append("   a.oid_producto, ");
    textSQL.append("   a.oid_um_cpra oid_um, ");
    textSQL.append("   a.cant_cpra_uc cant, ");
    textSQL.append("   a.precio_neto_bonif precio, ");
    ...
    textSQL.append("   e.razon_social razon_social, ");
    textSQL.append("   1 signo ");
    ...
    while (iterClasif.hasNext()) {
    	...
    	} else if (clasif.getNickname().equals(Proveedor.NICKNAME)) {
    ...
    textSQL.append("   e.oid_proveedor = b.oid_proveedor and ");
  ...
  public static List getEstadisticaOC(java.util.Date fechaDesde,
  	...
  	return (List) ObjetoLogico.getObjects(EstadisticaOC.NICKNAME,
         DBEstadisticaOC.SELECT_BY_FECHA_DESDE_HASTA,
         condiciones,
         new ListObserver(),
         aSesion);
  }
