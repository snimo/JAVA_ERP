...
public class TraerCostoConvAUMVtaGral extends Operation {

  public TraerCostoConvAUMVtaGral() {
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
	...
	ValorClasifEntProdGen producto = ValorClasifEntProdGen.findByOid(mapaDatos.getInteger("oid_producto"), this.getSesion());
