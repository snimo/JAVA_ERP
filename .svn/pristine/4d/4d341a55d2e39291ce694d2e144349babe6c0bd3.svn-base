...
public class SaveRecluLlegoPersona extends Operation {

	public SaveRecluLlegoPersona() {
	}
	...
	public void execute(MapDatos mapaDatos) throws BaseException {
		...
		if (recluProcesoCandi.isSeAnuncio())
			throw new ExceptionValidation(null,"Ya se registro el ingreso de la persona.");
		
		recluProcesoCandi.setSeAnuncio(true);
		recluProcesoCandi.setFecHorSeAnuncio(Util.getFechaActual(this.getSesion()));
