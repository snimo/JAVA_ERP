...
public class DBEstadisticaPedidos extends DBObjetoPersistente {
  ...
  private PreparedStatement selectByFechaDesdeHasta(Object aCondiciones) throws BaseException, SQLException {
    ...
    textSQL.append("   a.oid_ped_det oid_cco_det, ");
    textSQL.append("   a.oid_cco_ped oid_cco, ");
    textSQL.append("   a.oid_producto, ");
    textSQL.append("   a.oid_um_ori oid_um, ");
    textSQL.append("   a.cant_um_ori cant, ");
    ...
    textSQL.append("   a.oid_cco_ped = b.oid_cco_ped and "); 
    textSQL.append("   c.oid_cco = b.oid_cco_ped and "); 
  ...
  public static List getEstadisticaPedidos(java.util.Date fechaDesde,
  	...
  	return (List) ObjetoLogico.getObjects(EstadisticaPedidos.NICKNAME,
         DBEstadisticaPedidos.SELECT_BY_FECHA_DESDE_HASTA,
         condiciones,
         new ListObserver(),
         aSesion);
  }
