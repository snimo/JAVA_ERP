...
public class AplicacionComproProvDet extends ObjetoLogico {

  public AplicacionComproProvDet() {
  }

  public static String NICKNAME = "cap.AplicacionComproProvDet";
  ...
  private TranProvVto tranProvVtoAplic;
  ...
  public TranProvVto getTranprovvtoAplic() throws BaseException {
    supportRefresh();
    return tranProvVtoAplic;
  }

  public void setTranprovvtoAplic(TranProvVto aTranProvVtoAplic) {
    this.tranProvVtoAplic =  aTranProvVtoAplic;
  }
 ...
 public static AplicacionComproProvDet findByOid(Integer oid , ISesion aSesion) throws BaseException {
   return (AplicacionComproProvDet) getObjectByOid(NICKNAME,oid,aSesion);
  }

 public static AplicacionComproProvDet findByCodigo(String codigo , ISesion aSesion) throws BaseException {
   return (AplicacionComproProvDet) getObjectByCodigo(NICKNAME,codigo,aSesion);
  }
