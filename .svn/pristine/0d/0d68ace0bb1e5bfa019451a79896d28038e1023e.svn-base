...
public class SaveRecluLlegoPersonaAnu extends Operation {

	public SaveRecluLlegoPersonaAnu() {
	}
	...
	public void execute(MapDatos mapaDatos) throws BaseException {
		...
		recluProcesoCandi.setSeAnuncio(false);
		recluProcesoCandi.setFecHorSeAnuncio(null);
