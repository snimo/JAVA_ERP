inherited FInhaIngCIP: TFInhaIngCIP
  Left = 137
  Top = 245
  Width = 822
  Height = 350
  BorderIcons = [biSystemMenu]
  Caption = 'Inhabilitar Ingreso o Egreso'
  DragKind = dkDrag
  DragMode = dmManual
    ...
    OnChangeField = <
      item
        ...
        Source.Strings = (
          ...
          '   operacion.AddAtribute(''accion'',''INHABILITAR''); '
    ...
    OnFormFunction = <
      item
        Source.Strings = (
          ...
          'begin'
          ''
          '  if (Varios.isFuncionSeguridadHabilitada(1007,'''',false)=false)'
          '     then begin'
          ''
          '             TInhabNov.First;'
          '             if (TInhabNov.Locate(''codigo'',''DES_ING'' ,[]))'
          '                then TInhabNov.borrar();'
          ''
          '             end;'
          ''
          '  if (Varios.isFuncionSeguridadHabilitada(1008,'''',false)=false)'
          '     then begin'
          ''
          '             TInhabNov.First;'
          '             if (TInhabNov.Locate(''codigo'',''DES_EGR'' ,[]))'
          '                then TInhabNov.borrar();'
          ''
          '             end;'
          ''
          '  if (Varios.isFuncionSeguridadHabilitada(1009,'''',false)=false)'
          '     then begin'
          ''
          '             TInhabNov.First;'
          '             if (TInhabNov.Locate(''codigo'',''AMBOS'' ,[]))'
          '                then TInhabNov.borrar();'
          ''
          '             end;'
          ''
          ...
          'begin'
          '  operacion.InicioOperacion();'
          '  operacion.setOper(''TraerInhhabilitacionesNov'');'
          '  operacion.execute();'
          'end;'
          ''
  ...
  object TInhabNov: TsnTable
    ...
    Left = 264
    Top = 96
    object TInhabNovcodigo: TStringField
      FieldName = 'codigo'
      Size = 50
    end
    object TInhabNovdescripcion: TStringField
      FieldName = 'descripcion'
      Size = 100
    end
  end
