...
public class UploadFotoPrincipalExcluido extends Operation {

	public UploadFotoPrincipalExcluido() {
	}

	public void execute(MapDatos mapaDatos) throws BaseException {

		String nombreArchivo = "FPE_1_"+mapaDatos.getString("nuevo_nombre");
