...
public class ValidarOrdenDeCompra extends Operation { 

  public ValidarOrdenDeCompra() { 
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException { 
    ...
    String comprobante = tc+"-"+letra+"-"+lugEmi+"-"+mapaDatos.getString("identificador");
    
    ordendecompracab = OrdenDeCompraCab.getOrdeDeCompra(comprobante,getSesion());
