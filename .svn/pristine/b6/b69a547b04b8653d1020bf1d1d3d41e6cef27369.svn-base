...
public class CertificadoRetencionGanancias extends ValorBase {
	
  public CertificadoRetencionGanancias() {
  }
  ...
  public void validarCertificado() throws BaseException {
  ...
  public void save() throws BaseException {
    ...
    if (this.getTipoOper().equals(ENTRADA)) {
      ...
      this.getValorCertificado().setLiquidado(new Boolean(false));
