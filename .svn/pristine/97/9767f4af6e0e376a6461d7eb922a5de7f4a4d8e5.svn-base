...
public class CertificadoRetIBDet extends ObjetoLogico {

  public CertificadoRetIBDet() {
  }

  public static String NICKNAME = "pag.CertificadoRetIBDet";
  ...
  public void setComproproveedor(ComproProveedorBase aComproproveedor) {
 ...
 public static CertificadoRetIBDet findByOid(Integer oid , ISesion aSesion) throws BaseException {
   return (CertificadoRetIBDet) getObjectByOid(NICKNAME,oid,aSesion);
  }

 public static CertificadoRetIBDet findByCodigo(String codigo , ISesion aSesion) throws BaseException {
   return (CertificadoRetIBDet) getObjectByCodigo(NICKNAME,codigo,aSesion);
  }
