...
public class TraerColGrillaValVarEsce extends Operation { 

  public TraerColGrillaValVarEsce() { 
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
  	...
  	IDataSet ds = matriz.getDSColumnasGrillaValores("TColumnasGrillaValores");
  	matriz.cargarDatosColGrillaValores(ds);
  	writeCliente(ds);
