...
public class TraerConceptosImpuestoPorTipo extends Operation {

  private String nombreTabla = "";

  public TraerConceptosImpuestoPorTipo() {
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
    ...
    String compoImpuesto = mapaDatos.getString("compoImpuesto");

    Iterator iterConcImpu =
        ConceptoImpuesto.getConcImpuByTipo(compoImpuesto,getSesion()).iterator();
