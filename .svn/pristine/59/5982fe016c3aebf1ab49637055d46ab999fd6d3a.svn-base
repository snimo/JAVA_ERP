...
public class TraerDefaultPedido extends Operation {

  private int oid = 0;
  public TraerDefaultPedido() {
  }
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
    ...
    if (sujeto!=null) {    	 
       ...
       Moneda monedaPedido = null;
       if (sujeto.getMonedaFactura()!=null)
    	   monedaFactura = sujeto.getMonedaFactura();
       else
    	   monedaFactura = Moneda.getMonedaCursoLegal(this.getSesion());
       if (sujeto.getMonedaPedido()!=null)
    	   monedaPedido = sujeto.getMonedaPedido();
       else
    	   monedaPedido = Moneda.getMonedaCursoLegal(this.getSesion());
  ...
  private IDataSet getDataSetDefaultPedido() {
    ...
    dataset.fieldDef(new Field("oid_moneda_presu",Field.INTEGER, 0));
    return dataset;
  }
  ...
  private void cargarRegistroDefaultPedido(IDataSet dataset,
    ...
    if (monedaPresupuesto!=null)
    	dataset.fieldValue("oid_moneda_presu",monedaPresupuesto.getOIDInteger());
    else
    	dataset.fieldValue("oid_moneda_presu","");
