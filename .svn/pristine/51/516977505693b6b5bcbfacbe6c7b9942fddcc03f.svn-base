...
public class TraerIngDiarioPorTCyTV extends Operation {
  ...
  public void execute(MapDatos mapaDatos) throws BaseException {
	  ...
	  while (iteratorReg.hasNext()) {
		  ...
		  cargarRegistroIngDiarioPorTCyTV(ds, ++secu, regCons.moneda, regCons.tipoCompro, regCons.fecha, regCons.tipoValor, regCons.calcTotal.getResult());
	  }
  ...
  private IDataSet getDSIngDiarioPorTCyTC() {
    ...
    dataset.create("TIngDiarioPorTCyTC");
  ...
  private void cargar(MovimientoCaja movimientoCaja) throws BaseException {
	  String clave = getClave(movimientoCaja.getComprobante().getTipoCompro(), movimientoCaja.getTipovalor(), movimientoCaja.getFechacaja());
