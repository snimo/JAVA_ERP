...
public class TraerTiposFactTableCubo extends Operation { 

  public TraerTiposFactTableCubo() { 
  }

  public void execute(MapDatos mapaDatos) throws BaseException { 
    IDataSet datasetTipos = getDataSetTipos();
    HashTableDatos tipos = FactTableCubo.getTipos();
    int secu = 0;
  ...
  private IDataSet getDataSetTipos() { 
    ...
    dataset.create("TTiposFactTable");
