...
public class PorcLibRetGan extends ObjetoLogico {

  public PorcLibRetGan() {
  }

  public static String NICKNAME = "pag.PorcLibRetGan";
 ...
 public static PorcLibRetGan findByOid(Integer oid , ISesion aSesion) throws BaseException {
   return (PorcLibRetGan) getObjectByOid(NICKNAME,oid,aSesion);
  }

 public static PorcLibRetGan findByCodigo(String codigo , ISesion aSesion) throws BaseException {
   return (PorcLibRetGan) getObjectByCodigo(NICKNAME,codigo,aSesion);
  }
 ...
 public void beforeSave() throws BaseException {
  ...
  public static List getPorcentajesLibRetGan(SujetoImpositivo sujetoImpositivo,
    ...
    return DBPorcLibRetGan.getPorcentajesLibRetGan(sujetoImpositivo,aSesion);
  }

  public static PorcLibRetGan getPorcentajesLibRetGan(SujetoImpositivo sujetoImpositivo,
                                                      java.util.Date aFecha,
                                                      ISesion aSesion) throws BaseException {
    return DBPorcLibRetGan.getPorcentajesLibRetGan(sujetoImpositivo,aFecha,aSesion);
  }
