inherited FMotFalloVisita: TFMotFalloVisita
  Top = 206
  Width = 749
  Height = 641
  Caption = 'Motivos Fallo Visita'
  PixelsPerInch = 96
  TextHeight = 13
  inherited PForm: TPanel
    ...
    inherited PCabecera: TPanel
      ...
      object DBECodigo: TsnDBEdit
        ...
        DataBinding.DataSource = DSTMotVisFalRRHH
  ...
  inherited DriverABM: TDriverABM
    OperTraerObjeto = 'TraerMotVisFalRRHH'
    OperGrabarObjeto = 'SaveMotVisFalRRHH'
    CargaDataSets = <
      item
        DataSet = TMotVisFalRRHH
        TableName = 'TMotVisFalRRHH'
      end>
    BajaLogica = <
      item
        DataSet = TMotVisFalRRHH
  ...
  object TMotVisFalRRHH: TsnTable [3]
    ...
    Left = 648
    Top = 59
    object TMotVisFalRRHHoid_mot_vis_fall: TIntegerField
      FieldName = 'oid_mot_vis_fall'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object TMotVisFalRRHHcodigo: TStringField
      DisplayWidth = 50
      FieldName = 'codigo'
      Size = 50
    end
    object TMotVisFalRRHHdescripcion: TStringField
      DisplayWidth = 100
      FieldName = 'descripcion'
      Size = 100
    end
    object TMotVisFalRRHHactivo: TBooleanField
      DefaultExpression = '1'
      FieldName = 'activo'
    end
  end
  object DSTMotVisFalRRHH: TDataSource [4]
    DataSet = TMotVisFalRRHH
    Left = 680
    Top = 59
  end
