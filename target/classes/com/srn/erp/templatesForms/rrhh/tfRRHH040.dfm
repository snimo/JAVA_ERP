inherited FCargaEvalLegMas: TFCargaEvalLegMas
  Left = 211
  Top = 11
  Width = 856
  Height = 958
  Caption = 'Carga Masiva de Evaluaciones de Desempe'#241'o'
        ...
        object Panel22: TPanel
          ...
          object Panel23: TPanel
            ...
            object snLabel11: TsnLabel
              ...
              Width = 256
              Height = 16
              Caption = 'Detalle de Evaluaciones de Legajos'
              Color = 10801663
              Font.Charset = ANSI_CHARSET
              Font.Color = clWindowText
              Font.Height = -13
          ...
          object dxDBGridSN1: TdxDBGridSN
            ...
            object dxDBGridSN1DBTableView1: TcxGridDBTableView
              ...
              DataController.DataSource = DSEvaluacionesLegajo
              DataController.Summary.DefaultGroupSummaryItems = <>
              DataController.Summary.FooterSummaryItems = <>
              DataController.Summary.SummaryGroups = <>
              OptionsBehavior.FocusCellOnTab = True
  ...
  inherited DriverABM: TDriverABM
    OperGrabarObjeto = 'SaveEvaluacionDesempMasi'
    CargaDataSets = <
      item
      ...
      item
        DataSet = TEvaluacionesLegajos
        TableName = 'TEvaluacionesLegajos'
      end>
    BajaLogica = <
      item
        DataSet = TEvaluacionCAB
    ...
    DataSetDet1 = TEvaluacionesLegajos
    DataSetDet2 = TCompetenciasEval
    DataSetDet3 = TAspectosDestacados
    DataSetDet4 = TAspectosAMejorar
    DataSetDet5 = TObsGenRRHH
    DataSetDet6 = TEvaluadores
    DataSetDet7 = TFirmas
    ControlFocoAlta = snDBLookup1
    ControlFocoModif = srnDBButtonPuesto
    DespuesDeGrabarAlta = asNothing
  end
  ...
  inherited DriverEvent: TDriverEvent
    ...
    OnValidate = <
      ...
      item
        ...
        Source.Strings = (
          'begin'
          '  if (not ((Sender.AsCurrency>=0) and (Sender.AsCurrency<=100)))'
          
            '     then raiseException(erCustomError,'#39'El puntaje debe encontra' +
            'rse entre 0 y 100'#39');'
          'end.')
      end
      item
        TableName = 'TEvaluacionesLegajos'
        ...
        Source.Strings = (
          'begin'
          '  ValidadorLeg.Value := Sender.AsString;'
          '  ValidadorLeg.Validar();  '
          'end.')
      end>
    OnChangeField = <
      item
    ...
    OnNuevoRegistro = <
      ...
      item
        ...
        Source.Strings = (
          'begin'
          '  DataSet.FieldName('#39'oid_eval_cab'#39').AsInteger :=  '
          '         TEvaluacionCAB.FieldName('#39'oid_eval_cab'#39').AsInteger;'
          'end.')
      end>
    OnDblClick = <
      item
    ...
    OnClickButtonColumn = <
      ...
      item
        ColumnName = 'dxDBGridSN1DBTableView1legajo'
        Source.Strings = (
          'begin'
          '  HelpLeg.Mostrar();'
          'end.')
  ...
  object TEvaluacionCAB: TsnTable
    ...
    FieldDefs = <
      ...
      item
        Name = 'oid_val_pue_fut'
        DataType = ftInteger
      end
      item
        Name = 'cod_val_pue_fut'
        DataType = ftString
        Size = 50
      end
      item
        Name = 'desc_val_pue_fut'
        DataType = ftString
        Size = 100
      end>
    IndexDefs = <>
  ...
  object TEvaluacionesLegajos: TsnTable
    DesignActivation = True
    AttachedAutoRefresh = True
    AttachMaxCount = 1
    FieldDefs = <
    ...
    Left = 186
    Top = 515
    object TEvaluacionesLegajosoid_eval_leg: TIntegerField
      FieldName = 'oid_eval_leg'
    end
    object TEvaluacionesLegajosoid_eval_cab: TIntegerField
      FieldName = 'oid_eval_cab'
    end
    object TEvaluacionesLegajosoid_legajo: TIntegerField
      FieldName = 'oid_legajo'
    end
    object TEvaluacionesLegajoslegajo: TStringField
      FieldName = 'legajo'
      Size = 50
    end
    object TEvaluacionesLegajosape_y_nom: TStringField
      FieldName = 'ape_y_nom'
      Size = 100
    end
    object TEvaluacionesLegajosfecha: TDateField
      FieldName = 'fecha'
    end
    object TEvaluacionesLegajospuntaje: TFloatField
      FieldName = 'puntaje'
    end
    object TEvaluacionesLegajosorden: TIntegerField
      AutoGenerateValue = arAutoInc
      FieldName = 'orden'
    end
  end
  object DSEvaluacionesLegajo: TDataSource
    DataSet = TEvaluacionesLegajos
    Left = 216
    Top = 515
  end
  object HelpLeg: TsnHelp
    Acepto = False
    Oid = 0
    Operacion = Operacion
    NickNameObjLog = 'su.Legajo'
    ...
    Campos = <
      ...
      item
        ...
        Longitud = 50
        Visible = True
        AsignarACampo = TEvaluacionesLegajoslegajo
        KeyField = False
        AnchoEnCaracteres = 50
        ActivarFiltro = True
      end
  ...
  object ValidadorLeg: TValidador
    Operacion = Operacion
    NickNameObjLog = 'su.Legajo'
    MensajeException = 'C'#243'digo de Legajo Inexistente'
    CampoOID = TEvaluacionesLegajosoid_legajo
    CampoDescripcion = TEvaluacionesLegajosape_y_nom
    NroQuery = 0
    Cache = True
    Left = 134
    Top = 778
