inherited FGradoLegajo: TFGradoLegajo
  Left = 133
  Top = 206
  Width = 749
  Height = 641
  Caption = 'Grados / Funciones de Legajos'
  PixelsPerInch = 96
  TextHeight = 13
  inherited PForm: TPanel
    ...
    inherited PCabecera: TPanel
      ...
      object DBECodigo: TsnDBEdit
        ...
        DataBinding.DataSource = DSTGradoLegajo
  ...
  inherited DriverABM: TDriverABM
    ...
    CargaDataSets = <
      item
        DataSet = TGradoLegajo
        TableName = 'TGradoLegajo'
      end>
    BajaLogica = <
      item
        DataSet = TGradoLegajo
  ...
  object TGradoLegajo: TsnTable [3]
    ...
    Left = 648
    Top = 59
    object TGradoLegajooid_grado_leg: TIntegerField
      FieldName = 'oid_grado_leg'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
    end
    object TGradoLegajocodigo: TStringField
      DisplayWidth = 20
      FieldName = 'codigo'
      Size = 50
    end
    object TGradoLegajodescripcion: TStringField
      DisplayWidth = 100
      FieldName = 'descripcion'
      Size = 100
    end
    object TGradoLegajoactivo: TBooleanField
      DefaultExpression = '1'
      FieldName = 'activo'
    end
  end
  object DSTGradoLegajo: TDataSource [4]
    DataSet = TGradoLegajo
    Left = 680
    Top = 59
  end
